...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SandboxPolicy: 'sandbox.md',
  PeerAskRequest: 'peer.md',
  PeerAskResult: 'peer.md',
  PeerMessage: 'peer.md',
  PeerSessionSummary: 'peer.md',
  PeerTranscriptRequest: 'peer.md',
  PeerTransport: 'peer.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SshEnvironment: 'connection options are owned by packages/ssh/ssh/README.md',
  SshWorldConnection: 'pool connection face is owned by packages/ssh/ssh/README.md',
  WorkspaceCreateOptions: 'workspace creation options are owned by packages/workspace/workspace/README.md',
  WorkspaceEnvironmentView: 'workspace-picker environment rows are owned by packages/api/workspace-controller/README.md',
  SshEnvironmentId: 'environment identity is owned by packages/ssh/ssh-environments/README.md',
  SshEnvironmentEntry: 'environment entry is owned by packages/ssh/ssh-environments/README.md',
  SshEnvironmentSummary: 'environment summary is owned by packages/ssh/ssh-environments/README.md',
  SshEnvironmentRuntime: 'environment runtime coordinates are owned by packages/ssh/ssh-environments/README.md',
  SshRemoteDirectory: 'remote directory level is owned by packages/ssh/ssh/README.md',
  SshRemoteDirectoryPolicy: 'remote directory creation policy is owned by packages/ssh/ssh/README.md',
