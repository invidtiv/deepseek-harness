...
function createFixtureWorld(options: FixtureOptions): FixtureWorld {
  ...
  const workspaceFileRemotes = {
    ...
    /**
     * Deterministic text reads for the file viewer: the same design-mock tree
     * the browse primitives serve, with directories refused.
     */
    ...
    /** Mixed file/directory listing for the file explorer over the same tree. */
