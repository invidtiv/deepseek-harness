 ...
 * What remains here is the contract other plugins' apply worlds reach for
 * panel transitions (main-panel selection and sidebar toggle, explorer toggle
 * from ui-file-explorer, file-viewer open/close from ui-file-viewer,
...
export interface ILayout {
  ...
  toggleSidebar(): void
  /** Toggle the explorer panel (closed ⟷ contract default width). */
  toggleExplorer(): void
  /** Open the file-viewer panel (no-op when already open). */
  openFileViewer(): void
...
export class LayoutController implements ILayout {
  ...
  /** Toggle the explorer panel (closed ⟷ contract default width). */
  toggleExplorer(): void {
    this.panels.toggleExplorer()
  }

  /** Open the file-viewer panel (no-op when already open). */
  openFileViewer(): void {
    this.panels.openFileViewer()
  }

  /** Close the file-viewer panel. */
  closeFileViewer(): void {
    this.panels.closeFileViewer()
  }
