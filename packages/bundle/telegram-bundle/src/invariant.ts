/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-telegram-bundle`.
 * @module @deepseek-ai/dsh-telegram-bundle/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-telegram-bundle'

/** Cordis companion plugin name. */
export const name = 'telegram-bundle-invariant'
