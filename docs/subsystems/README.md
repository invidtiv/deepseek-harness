...
| [peer.md](peer.md) | the peer Harness seam: the named transport registry, `PeerTransport`, the ask/transcript request and result types, and the `PeerErrorCode` taxonomy |
